...
export default function Profile() {
  ...
  const { data: estimate } = trpc.profile.estimateMaxNatural.useQuery(
    undefined,
    { enabled: !!profile }
  );
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your personal information to get better recommendations.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <p className="font-semibold">
                    Max Natural Potential Estimate
                  </p>
                  {estimate.maxPotentialWeightAt10PercentBF ? (
                    <p className="text-2xl">
                      ~{estimate.maxPotentialWeightAt10PercentBF} kg{" "}
