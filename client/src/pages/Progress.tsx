...
export default function Progress() {
  ...
  // ⚡ Bolt Optimization: Memoize chart data calculation
  // Impact: Prevents expensive array slicing, reversing, and date formatting on every re-render.
  // This reduces main thread blocking during form input and tab switching, especially with many logs.
